		...
		<tbody>
			<tr>
				...
				<td>
					...
					<input type="button" class = "btn btn-info" value="Random" onclick="random()"/>
				</td>
			</tr>
			<tr style="height:3em">
...
<form action="#" method="get" onsubmit="return false">
	<table class = "table">
		...
		<tbody>
			<tr>
				<td>Subscripts</td>
				<td><code class = "eqn">N = N<span class="feature">2</span></code></td>
				<td>N ? N<sub>2</sub></td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('N = N2')"/></td>
			</tr>
			<tr>
				<td>Compounds</td>
				<td><code class = "eqn">H2 + O2 = <span class="feature">H2O</span></code></td>
				<td>H<sub>2</sub> + O<sub>2</sub> ? H<sub>2</sub>O</td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('H2 + O2 = H2O')"/></td>
			</tr>
			<tr>
				<td>Groups</td>
				<td><code class = "eqn">Mg<span class="feature">(OH)</span>2 = MgO + H2O</code></td>
				<td>Mg(OH)<sub>2</sub> ? MgO + H<sub>2</sub>O</td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('Mg(OH)2 = MgO + H2O')"/></td>
			</tr>
			<tr>
				<td>Ions</td>
				<td><code class = "eqn">H<span class="feature">^+</span> + CO3<span class="feature">^2-</span> = H2O + CO2</code></td>
				<td>H<sup>+</sup> + CO<sub>3</sub><sup>2-</sup> ? H<sub>2</sub>O + CO<sub>2</sub></td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('H^+ + CO3^2- = H2O + CO2')"/></td>
			</tr>
			<tr>
				<td>Electrons</td>
				<td><code class = "eqn">Fe^3+ + <span class="feature">e</span> = Fe</code></td>
				<td>Fe<sup>3+</sup> + e<sup>-</sup> ? Fe</td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('Fe^3+ + e = Fe')"/></td>
			</tr>
			<tr>
				<td>No space</td>
				<td><code class = "eqn">A3^-+B2^2+=A5B+e</code></td>
				<td>A<sub>3</sub><sup>-</sup> + B<sub>2</sub><sup>2+</sup> ? A<sub>5</sub>B + e<sup>-</sup></td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('A3^-+B2^2+=A5B+e')"/></td>
			</tr>
			<tr>
				<td>More space</td>
				<td><code class = "eqn">C 3 H 5 ( O H ) 3 + O 2 = H 2 O + C O 2</code></td>
				<td>C<sub>3</sub>H<sub>5</sub>(OH)<sub>3</sub> + O<sub>2</sub> ? H<sub>2</sub>O + CO<sub>2</sub></td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('C 3 H 5 ( O H ) 3 + O 2 = H 2 O + C O 2')"/></td>
			</tr>
			<tr>
				<td>Optional 1</td>
				<td><code class = "eqn">H<span class="feature">1</span>^<span class="feature">1</span>+ + e = H<span class="feature">1</span>^<span class="feature">1</span>-</code></td>
				<td>H<sup>+</sup> + e<sup>-</sup> ? H<sup>-</sup></td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('H1^1+ + e = H1^1-')"/></td>
			</tr>
			<tr>
				<td>Flexible names</td>
				<td><code class = "eqn"><span class="feature">Foo</span>^5+ + <span class="feature">Bar</span>^3- = <span class="feature">Foo</span><span class="feature">Bar</span>2 + <span class="feature">Foo</span><span class="feature">Bar</span>^-</code></td>
				<td>Foo<sup>5+</sup> + Bar<sup>3-</sup> ? FooBar<sub>2</sub> + FooBar<sup>-</sup></td>
				<td><input type="button" class="btn btn-success" value="Show" onclick="demo('Foo^5+ + Bar^3- = FooBar2 + FooBar^-')"/></td>
			</tr>
		</tbody>
	</table>
</form>
